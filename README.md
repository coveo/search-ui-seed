...
`npm run dev` will start a [webpack dev server](https://webpack.github.io/docs/webpack-dev-server.html). After it finishes, load http://localhost:8080/index.html in a browser, and the `index.html` page should load.
